...
export function AnalyticsScreen({ analytics, metrics, portfolios, days }: { analytics: AnalyticsData; metrics: DashboardMetrics; portfolios: AdminPortfolio[]; days: 7 | 30 | 90 | 365 }) {
  ...
  return <div className="admin-page">
    ...
    <section className="admin-card admin-analytics-note"><BriefcaseBusiness aria-hidden="true" /><p>Analytics are derived only from existing <code>portfolio_events</code> view records. No sample or inferred engagement data is shown.</p></section>
  </div>;
}
